export type RuneId='ward'|'fireball'|'lightning'|'frost'|'mend'|'dispel'|'water'|'star';
...
export const RUNE_IDS:RuneId[]=['ward','fireball','lightning','frost','mend','dispel','water','star'];
