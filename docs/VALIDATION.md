...
- Automated tests: 39 passing (including 10 mid-stroke regression checks, plus gesture/combat/study and worker checks). These do not use a physical hand or camera.
