...
- Automated tests: 60 passing (including 10 mid-stroke regressions and 3 tutorial/feedback checks and 4 localization checks, 9 burn/Water/migration checks, and Water shape variants, plus gesture/combat/study and worker checks). These do not use a physical hand or camera.
