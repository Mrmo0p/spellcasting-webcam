...
- Automated tests: 29 passing (27 gesture/combat/study checks plus worker protocol and actual MediaPipe global-export checks). These do not use a physical hand or camera.
