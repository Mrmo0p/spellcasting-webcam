...
- Automated tests: 43 passing (including 10 mid-stroke regressions and 3 tutorial/feedback checks, plus gesture/combat/study and worker checks). These do not use a physical hand or camera.
